...
def create_feature_engineered_dataset_approach_b(df, min_games_for_season_avg=1):
    ...
    We track label_10_plus, label_15_plus, label_20_plus based on the *next* game (i+1).
    """
    # Ensure datetime
    ...
    for (player_id, season), group in grouped:
        ...
        for i in range(len(group) - 1):
            ...
            # current_game_points = current_game["points"] is only used for computations if we want
            # but it's not the label. The label is next_game.

            # Next game points => used for labels
            ...
            # Deviation from rolling means (using current_game's points)
            ...
            # Average points deviation in season
            ...
            row_dict = {
                ...
                "points_current_game": current_points,   # *optional* if you want i’s points
                "ppg_last_5": ppg_5,
                "ppg_last_10": ppg_10,
                "ppg_last_20": ppg_20,
...
if __name__ == "__main__":
    ...
    feature_cols = [
        ...
        # "points_current_game" -> optional if you consider that "known" at time i (some do, some don't).
    ]
