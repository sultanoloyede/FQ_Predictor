...
import unicodedata  # Ensure this import is at the top of your script
...
def build_latest_features_approach_b_no_season(df):
    ...
    for player_id, group in grouped:
        ...
        pct_10_plus_10 = (last_10_slice["points"] >= 10).mean()
        pct_15_plus_10 = (last_10_slice["points"] >= 15).mean()
        pct_20_plus_10 = (last_10_slice["points"] >= 20).mean()
        ...
        row_dict = {
            ...
            "pct_10_plus_last_10": pct_10_plus_10,
            "pct_15_plus_last_10": pct_15_plus_10,
            "pct_20_plus_last_10": pct_20_plus_10,
    ...
    for tname in thresholds:
        ...
        try:
            ...
            if hasattr(model, 'get_booster'):
                ...
                logging.info(f"Model {tname} feature names: {booster.feature_names}")
        except Exception as e:
