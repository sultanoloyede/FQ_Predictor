...
def create_feature_engineered_dataset_approach_b(df, min_games_for_season_avg=1):
    ...
    We track label_4_plus, label_6_plus, label_8_plus, label_10_plus based on the *next* game (i+1).
    """
    # Ensure datetime
    ...
    for (player_id, season), group in grouped:
        ...
        for i in range(len(group) - 1):
            ...
            # current_game_rebounds = current_game["rebounds"] is only used for computations if we want
            # but it's not the label. The label is next_game.

            # Next game rebounds => used for labels
            ...
            # Deviation from rolling means (using current_game's rebounds)
            ...
            # Average rebounds deviation in season
            ...
            row_dict = {
                ...
                "rebounds_current_game": current_rebounds,   # *optional* if you want i’s rebounds
                "rpg_last_5": rpg_5,
                "rpg_last_10": rpg_10,
                "rpg_last_20": rpg_20,
...
if __name__ == "__main__":
    ...
    feature_cols = [
        ...
        "rpg_last_5", "rpg_last_10", "rpg_last_20",
        "rpg_season",
        ...
        # "rebounds_current_game" -> optional if you consider that "known" at time i (some do, some don't).
    ]
    ...
    for tname, label_col in thresholds.items():
        ...
        # Decide SMOTE usage
        if tname in ["4_plus", "6_plus", "8_plus"]:
