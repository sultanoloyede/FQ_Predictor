...
def build_latest_features_approach_b_no_season(df):
    ...
    for player_id, group in grouped:
        ...
        pct_1_plus_l5 = (last_5_slice["3points"] >= 1).mean()
        pct_2_plus_l5 = (last_5_slice["3points"] >= 2).mean()
        pct_3_plus_l5 = (last_5_slice["3points"] >= 3).mean()

        last_10_slice = prev_games.iloc[-10:] if len(prev_games) >= 10 else prev_games
        pct_1_plus_l10 = (last_10_slice["3points"] >= 1).mean()
        pct_2_plus_l10 = (last_10_slice["3points"] >= 2).mean()
        pct_3_plus_l10 = (last_10_slice["3points"] >= 3).mean()

        last_20_slice = prev_games.iloc[-20:] if len(prev_games) >= 20 else prev_games
        pct_1_plus_l20 = (last_20_slice["3points"] >= 1).mean()
        pct_2_plus_l20 = (last_20_slice["3points"] >= 2).mean()
        pct_3_plus_l20 = (last_20_slice["3points"] >= 3).mean()
        ...
        avg_3points_dev_season = (
            prev_games["3points"].apply(lambda x: x - pg3_season).mean()
        ...
        row_dict = {
            ...
            "pct_1_plus_last_5": pct_1_plus_l5,
            "pct_2_plus_last_5": pct_2_plus_l5,
            "pct_3_plus_last_5": pct_3_plus_l5,
            "pct_1_plus_last_10": pct_1_plus_l10,
            "pct_2_plus_last_10": pct_2_plus_l10,
            "pct_3_plus_last_10": pct_3_plus_l10,
            "pct_1_plus_last_20": pct_1_plus_l20,
            "pct_2_plus_last_20": pct_2_plus_l20,
            "pct_3_plus_last_20": pct_3_plus_l20,
...
def main():
    ...
    feature_cols = [
        ...
        "pct_1_plus_last_5", "pct_2_plus_last_5", "pct_3_plus_last_5",
        "pct_1_plus_last_10", "pct_2_plus_last_10", "pct_3_plus_last_10",
        "pct_1_plus_last_20", "pct_2_plus_last_20", "pct_3_plus_last_20",
        "pct_1_plus_season", "pct_2_plus_season", "pct_3_plus_season",
    ...
    # 4) Load models (3_plus, 2_plus, 1_plus)
    ...
    # 6) Generate top-25 for 3_plus, 2_plus, 1_plus without duplicates
